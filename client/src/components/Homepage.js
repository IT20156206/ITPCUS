    ...
    return(
      <div className ="container">
         ...
         <table className = "table table-striped table-dark table-responsive table-hover" ref={(el) => (this.componentRef = el)}> 
          ...
          <button className ="btn btn-success"><a href ="/add"style ={{textDecoration:'none',color:'white'}}><i class="fa fa-plus-square" aria-hidden="true"></i> &nbsp; Add New customers</a>
          </button>
          ...
          <button className ="btn btn-danger"><a href ="/delete"style ={{textDecoration:'none',color:'white'}}><i class="fa fa-minus-square" aria-hidden="true"></i> &nbsp; Deleted Customers</a>
